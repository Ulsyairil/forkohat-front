...
export const actions = {
  async pagination(context, value) {
    try {
      const response = await this.$axios.post('/admin/orgs', {
        page: value.page,
        limit: value.limit,
        order: value.order,
        search: value.search,
  ...
  async all(context, value) {
    try {
      const response = await this.$axios.get('/admin/orgs')
  ...
  async get(context, value) {
    try {
      const response = await this.$axios.get('/admin/org', {
        params: { id: value },
      })
  ...
  async create(context, value) {
    try {
      ...
      const response = await this.$axios.post('/admin/org', payload)
      console.log(response)
      return response
    } catch (error) {
      console.log(error)
  ...
  async edit(context, value) {
    try {
      ...
      const response = await this.$axios.put('/admin/org', payload)
      console.log(response)
      return response
    } catch (error) {
      console.log(error)
  ...
  async destroy(context, value) {
    try {
      const response = await this.$axios.delete('/admin/org', {
        data: { id: value },
      })
      console.log(response)
      return response
