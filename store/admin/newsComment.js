...
export const actions = {
  async pagination(context, value) {
    try {
      const response = await this.$axios.post('/admin/news/comments', {
  ...
  async get(context, value) {
    try {
      const response = await this.$axios.get('/admin/news/comment', {
        params: { id: value },
      })
  ...
  async create(context, value) {
    try {
      ...
      const response = await this.$axios.post('/admin/news/comment', payload)
      return response
    } catch (error) {
      console.log(error)
      console.log(error.response)
  ...
  async edit(context, value) {
    try {
      ...
      const response = await this.$axios.put('/admin/news/comment', payload)
      console.log(response)
      return response
    } catch (error) {
      console.log(error)
  ...
  async destroy(context, value) {
    try {
      const response = await this.$axios.delete('/admin/news/comment', {
        data: { id: value },
      })
      console.log(response)
      return response
