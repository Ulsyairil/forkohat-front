...
export const createStructure = async (req = request, res = response, next) => {
  try {
    ...
    const response = await axios.post('/superadmin/arrangement', form, {
      headers: {
        Authorization: bearer,
        ...form.getHeaders(),
      },
...
export const editStructure = async (req = request, res = response, next) => {
  try {
    ...
    const response = await axios.put('/superadmin/arrangement', form, {
      headers: {
        Authorization: bearer,
        ...form.getHeaders(),
      },
...
export const destroyStructure = async (req = request, res = response, next) => {
  try {
    const bearer = req.get('authorization') ?? ''
    const response = await axios.delete('/superadmin/arrangement', {
      data: {
        id: req.body.id,
      },
      headers: {
