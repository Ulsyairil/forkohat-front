...
export const createStructureItem = async (req = request, res = response, next) => {
  try {
    ...
    const response = await axios.post('/superadmin/arrangement/item', form, {
      headers: {
        Authorization: bearer,
        ...form.getHeaders(),
      },
...
export const editStructureItem = async (req = request, res = response, next) => {
  try {
    ...
    const response = await axios.put('/superadmin/arrangement/item', form, {
      headers: {
        Authorization: bearer,
        ...form.getHeaders(),
      },
