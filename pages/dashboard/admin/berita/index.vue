                    ...
                    <v-col cols="12" sm="12" md="8" lg="8">
                      ...
                      <div>
                        <v-btn
                          ...
                          small
                          text
                          :to="`/dashboard/admin/berita/${item.id}`"
                        >
                          <v-icon>edit</v-icon>
                        </v-btn>
                        <v-btn
...
export default {
  ...
  computed: {
    page: {
      get() {
        return this.$store.state.admin.news.pagination.page
      },
      set(newValue) {
        this.$store.commit('admin/news/exportPaginationPage', newValue)
      },
    },
    limit: {
      get() {
        return this.$store.state.admin.news.pagination.limit
      },
      set(newValue) {
        this.$store.commit('admin/news/exportPaginationLimit', newValue)
      },
    },
    order: {
      get() {
        return this.$store.state.admin.news.pagination.order
      },
      set(newValue) {
        this.$store.commit('admin/news/exportPaginationOrder', newValue)
      },
    },
    trash: {
      get() {
        return this.$store.state.admin.news.pagination.trash
      },
      set(newValue) {
        this.$store.commit('admin/news/exportPaginationTrash', newValue)
      },
    },
    search: {
      get() {
        return this.$store.state.admin.news.pagination.search
      },
      set(newValue) {
        this.$store.commit('admin/news/exportPaginationSearch', newValue)
      },
    },
    items() {
      return this.$store.state.admin.news.pagination.data
    },
  },
  methods: {
    serverBaseUrl() {
    ...
    async addNews(more) {
      ...
      const response = await this.$store.dispatch('admin/news/create', payload)
    ...
    async dump(id) {
      const response = await this.$store.dispatch('admin/news/delete', id)
    ...
    async restore(id) {
      const response = await this.$store.dispatch('admin/news/restore', id)
    ...
    async destroy(id) {
      ...
      if (notif.isConfirmed) {
        const response = await this.$store.dispatch('admin/news/destroy', id)
  ...
  async fetch() {
    await this.$store.dispatch('admin/news/pagination', {
      page: this.page,
      limit: this.limit,
      order: this.order,
      trash: this.trash,
