            ...
            <div class="mb-5">
              <div class="d-flex flex-row flex-wrap mb-3">
                <v-btn
                  ...
                  class="mt-3 mr-4"
                  color="primary"
                  :to="`/dashboard/admin/umum/tatanan/${$route.params.idTatanan}/kegiatan/add`"
                >
                  <v-icon>add</v-icon>
                  Buat
                </v-btn>
                    ...
                    <v-col cols="12" sm="12" md="8" lg="8">
                      ...
                      <div>
                        <v-btn
                          ...
                          small
                          text
                          :to="`/dashboard/admin/umum/tatanan/${$route.params.idTatanan}/kegiatan/${item.id}`"
                        >
                          <v-icon>edit</v-icon>
                        </v-btn>
                        <v-btn
...
export default {
  ...
  computed: {
    ...
    items() {
      return this.$store.state.admin.event.pagination.data
    },
  },
  methods: {
    serverBaseUrl() {
  ...
  async fetch() {
    ...
    if (responseGetArrangement.status == 200) {
      ...
      this.breadCrumbs[0].href = `/dashboard/admin/umum`
    }
  },
  mounted() {
    this.fetchData()
