              ...
              >
                ...
                <div>
                  <v-btn
                    ...
                    >Simpan</v-btn
                  >
                  <v-btn type="button" @click="closeEditDialog()"
                    >Kembali</v-btn
                  >
                </div>
              </v-form>
...
export default {
  ...
  computed: {
    page: {
      ...
      set(newValue) {
        this.$store.commit('admin/faq/exportPaginationPage', newValue)
      },
    },
    limit: {
      get() {
      ...
      set(newValue) {
        this.$store.commit('admin/faq/exportPaginationLimit', newValue)
      },
    },
    order: {
      get() {
      ...
      set(newValue) {
        this.$store.commit('admin/faq/exportPaginationOrder', newValue)
      },
    },
    search: {
      get() {
      ...
      set(newValue) {
        this.$store.commit('admin/faq/exportPaginationSearch', newValue)
      },
    },
    items() {
  ...
  methods: {
    ...
    async submitFaq(more = Boolean) {
      ...
      const response = await this.$store.dispatch('admin/faq/create', payload)
    ...
    async openEditDialog(id) {
      const response = await this.$store.dispatch('admin/faq/get', id)
    ...
    async submitEditFaq() {
      ...
      const response = await this.$store.dispatch('admin/faq/edit', payload)
    ...
    async destroy(id) {
      ...
      if (notif.isConfirmed) {
        const response = await this.$store.dispatch('admin/faq/destroy', id)
  ...
  async fetch() {
    await this.$store.dispatch('admin/faq/pagination', {
      page: this.page,
      limit: this.limit,
      order: this.order,
      search: this.search,
