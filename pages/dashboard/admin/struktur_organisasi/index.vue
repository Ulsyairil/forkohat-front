...
export default {
  ...
  computed: {
    chartData() {
      return this.$store.state.admin.org.data
    },
    page: {
      get() {
    ...
    tableData() {
      return this.$store.state.admin.org.pagination.data
    },
    userData() {
      return this.$store.state.admin.user.all
    },
  },
  methods: {
    serverBaseUrl() {
  ...
  async fetch() {
    this.$d3
      .json(`${this.serverBaseUrl()}/api/v1/admin/orgs`, {
