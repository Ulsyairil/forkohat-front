...
export default {
  ...
  computed: {
    page: {
      ...
      set(newValue) {
        this.$store.commit('member/program/exportPaginationPage', newValue)
      },
    },
    limit: {
      get() {
      ...
      set(newValue) {
        this.$store.commit('member/program/exportPaginationLimit', newValue)
      },
    },
    order: {
      get() {
      ...
      set(newValue) {
        this.$store.commit('member/program/exportPaginationOrder', newValue)
      },
    },
    programData() {
  ...
  async fetch() {
    await this.$store.dispatch('member/program/pagination', {
      page: this.page,
      limit: this.limit,
      order: this.order,
    })
