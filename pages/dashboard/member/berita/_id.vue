...
export default {
  ...
  computed: {
    newsId: {
      ...
      set(newValue) {
        this.$store.commit(
          'member/newsComment/exportPaginationEventId',
          newValue
        )
      },
    },
    page: {
      ...
      set(newValue) {
        this.$store.commit(
          'member/newsComment/exportPaginationPage',
          newValue
        )
      },
    },
    limit: {
      ...
      set(newValue) {
        this.$store.commit(
          'member/newsComment/exportPaginationLimit',
          newValue
        )
      },
    },
    order: {
      ...
      set(newValue) {
        this.$store.commit(
          'member/newsComment/exportPaginationOrder',
          newValue
        )
      },
    },
  ...
  async fetch() {
    ...
    await this.$store.dispatch('member/newsComment/pagination', {
      news_id: this.$route.params.id,
      page: this.page,
      limit: this.limit,
      order: this.order,
