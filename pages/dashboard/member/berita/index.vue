...
export default {
  ...
  computed: {
    page: {
      ...
      set(newValue) {
        this.$store.commit('member/news/exportPaginationPage', newValue)
      },
    },
    limit: {
      get() {
      ...
      set(newValue) {
        this.$store.commit('member/news/exportPaginationLimit', newValue)
      },
    },
    order: {
      get() {
      ...
      set(newValue) {
        this.$store.commit('member/news/exportPaginationOrder', newValue)
      },
    },
    trash: {
      get() {
      ...
      set(newValue) {
        this.$store.commit('member/news/exportPaginationTrash', newValue)
      },
    },
    search: {
      get() {
      ...
      set(newValue) {
        this.$store.commit('member/news/exportPaginationSearch', newValue)
      },
    },
    items() {
  ...
  methods: {
    ...
    async dump(id) {
      const response = await this.$store.dispatch('member/news/delete', id)
    ...
    async restore(id) {
      const response = await this.$store.dispatch('member/news/restore', id)
  ...
  async fetch() {
    await this.$store.dispatch('member/news/pagination', {
      page: this.page,
      limit: this.limit,
      order: this.order,
      trash: this.trash,
