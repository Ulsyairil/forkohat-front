...
export default {
  ...
  computed: {
    page: {
      get() {
        return this.$store.state.superadmin.faq.pagination.page
      },
      set(newValue) {
    ...
    limit: {
      get() {
        return this.$store.state.superadmin.faq.pagination.limit
      },
      set(newValue) {
    ...
    order: {
      get() {
        return this.$store.state.superadmin.faq.pagination.order
      },
      set(newValue) {
    ...
    search: {
      get() {
        return this.$store.state.superadmin.faq.pagination.search
      },
      set(newValue) {
    ...
    items() {
      return this.$store.state.superadmin.faq.pagination.data
    },
  },
  methods: {
    serverBaseUrl() {
