...
export default {
  ...
  computed: {
    page: {
      get() {
        return this.$store.state.superadmin.gallery.pagination.page
      },
      set(newValue) {
    ...
    limit: {
      get() {
        return this.$store.state.superadmin.gallery.pagination.limit
      },
      set(newValue) {
    ...
    order: {
      get() {
        return this.$store.state.superadmin.gallery.pagination.order
      },
      set(newValue) {
    ...
    showed: {
      get() {
        return this.$store.state.superadmin.gallery.pagination.showed
      },
      set(newValue) {
        this.$store.commit(
    ...
    galleryData() {
      return this.$store.state.superadmin.gallery.pagination.data
    },
  },
  methods: {
    serverBaseUrl() {
