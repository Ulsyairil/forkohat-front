...
export default {
      ...
      breadCrumbs: [
        {
          text: 'Daftar Berita',
          disabled: false,
          href: '/dashboard/superadmin/berita',
        },
        {
          text: '',
          disabled: false,
  ...
  computed: {
    newsId: {
      get() {
        return this.$store.state.superadmin.newsComment.pagination.news_id
      },
      set(newValue) {
        this.$store.commit(
    ...
    page: {
      get() {
        return this.$store.state.superadmin.newsComment.pagination.page
      },
      set(newValue) {
        this.$store.commit(
    ...
    limit: {
      get() {
        return this.$store.state.superadmin.newsComment.pagination.limit
      },
      set(newValue) {
        this.$store.commit(
    ...
    order: {
      get() {
        return this.$store.state.superadmin.newsComment.pagination.order
      },
      set(newValue) {
        this.$store.commit(
    ...
    newsCommentData() {
      return this.$store.state.superadmin.newsComment.pagination.data
    },
    userLoggedIn() {
