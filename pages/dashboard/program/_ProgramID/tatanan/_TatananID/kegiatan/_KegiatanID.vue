<template>
  <v-container>
    <v-row>
      ...
      <v-col cols="12" sm="11" md="11" lg="11" xl="11">
        <span class="display-1 font-weight-bold"
          >Ubah Kegiatan ID {{ $route.params.KegiatanID }} | Tatanan ID
          {{ $route.params.TatananID }}</span
        >
      </v-col>
    </v-row>
    ...
    <v-form class="mt-5">
      ...
      <v-text-field label="Judul Kegiatan" outlined></v-text-field>
      <v-textarea label="Deskripsi Singkat" outlined></v-textarea>
      <v-dialog
        ref="dialog"
        v-model="modal"
