<template>
  <v-container>
    ...
    <v-row no-gutters class="mt-5 mb-15" align="center" justify="center">
      ...
      <v-col cols="9">
        <h2>Balikpapan Utara</h2>
        <p>
          Balikpapan Utara adalah sebuah kecamatan di Kota Balikpapan, Provinsi
    ...
    <v-row no-gutters class="mt-5 mb-10" align="center" justify="center">
      <v-col cols="3">
        <v-img
          contain
      ...
      <v-col cols="9">
        <h2>Balikpapan Barat</h2>
        <p>
          Balikpapan Barat adalah sebuah kecamatan di Kota Balikpapan,
          Kalimantan Timur, Indonesia. Mayoritas penduduk di kecamatan ini
          adalah pendatang dari berbagai daerah seperti Pulau Madura, Jawa,
          Sulawesi, Kalsel, dan lain sebagainya. Luas dari kecamatan ini adalah
          37,49 km² di perairan, dan di daratan seluas 179,952 km² atau sekitar
          35,75% Luas Kota Balikpapan. Luas dari kecamatan ini adalah 37,49 km²
          di perairan, dan di daratan seluas 179,952 km² atau sekitar 35,75%
          Luas Kota Balikpapan
        </p>
