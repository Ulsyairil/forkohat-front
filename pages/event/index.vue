        ...
        <v-data-iterator :items="items" :items-per-page.sync="itemsPerPage" :page.sync="page" :search="search"
            ...
            <template v-slot:default="props">
                <v-row>
                    ...
                    <v-card>
                        <v-img src="https://cdn.vuetifyjs.com/images/cards/road.jpg" class="white--text align-end" gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)"
                            height="200px">
                        ...
                        <v-card-subtitle>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis porta nunc at gravida scelerisque. Aenean ultrices arcu et
                        ultricies hendrerit. Vestibulum volutpat urna vitae est placerat, non bibendum nisi laoreet. In luctus aliquam arcu id
                        placerat. Sed egestas felis laoreet, mattis nisi id, fermentum quam....</v-card-subtitle>
