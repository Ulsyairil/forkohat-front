<template>
  <div>
    ...
    <form id="gallery-form" @submit.prevent="formSubmit()">
      <div class="form-group">
        <label>Nama Gambar</label>
        <input
          type="text"
          class="form-control"
          v-model="picture_name"
          required
        />
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" v-model="picture_desc" />
      </div>
...
export default {
  ...
  mounted() {
    this.formValidation('gallery-form')
  },
  methods: {
    async formSubmit() {
      try {
        ...
        const validate = this.formValidation('gallery-form').validate()
        ...
        formData.append('picture_description', this.picture_desc)
